    ...
    return (
        <div className="min-h-screen px-4 py-10 text-slate-100">
            <div className="mx-auto max-w-3xl">
                ...
                <Card className="
lassName="space-y-6" onSubmit={handleSubmit}>
                        <Input
                            name="title"
                            label="Ticket Name"
               ...
               e						<div className="grid gap-4 md:grid-cols-3">el className="text-sm font-medium text-slate-200">Status</label>
                                <select
                                    name="status"
                                    defaultValue="Open"
                            ...
                            <div className="flex flex-col gap-1">
                                <label xt-slate-200">Priority</label>
                                <select
                                    name="priority"
                                    defaultValue="Medium"
                                    className="rounded-lg border border-slate-700 bg-slate-900 px-3 py-2 text-sm"
                            ...
                            <div className="flex flex-col gap-1">
                                <label className="text-sm folabel>
                                <select
                                    name="category"
                                    defaultValue=""
                        ...
                        <Textarea
                            name="description"
                            label="Description"
                     ue in a few sen			<Textarea                  minRows={4 }
                            isRequired
                        />
                        ...
                        <div className="mt-6 flex justify-end gap-4">
                            <Button
                                type="button"
                                vari						<div className="mt-6 flex justify-end gap-4">                     className="px-6 text-slate-200 hover:bg-white/10 transition-all duration-200 active:scale-95"
                                onPress={() => router.back()}
                            >
                                Cancel
                            </Button>
